...
/* Private variables ---------------------------------------------------------*/
uint16_t SizeCharwrite = 64;
uint16_t SizeSendnum = 1;
...
extern char blereceivebuf[256];
extern char bletransmitbuf[256];
/* USER CODE END PV */
...
#define COPY_SENDNUM_UUID(uuid_struct)    COPY_UUID_128(uuid_struct,0x00,0x00,0x00,0x01,0x8e,0x22,0x45,0x41,0x9d,0x4c,0x21,0xed,0xae,0x82,0xed,0x19)
...
void SVCCTL_InitCustomSvc(void)
{
   ...
   *                                2 for charWrite +
   *                                2 for sendnum +
   *                                1 for sendnum configuration descriptor +
   *                              = 6
   *
